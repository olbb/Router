...
public class RouteMeta {
     ...
     * @param type        type
     */
    public RouteMeta(Router route, Class<?> destination, RouteType type) {
     ...
     * @param paramsType paramsType
     */
    public RouteMeta(Router route, Element rawType, RouteType type, Map<String, Integer> paramsType) {
